...
parser.add_argument("--mllm_path", default="/mnt/DATA/chenxiaoli/MLLM/Qwen2.5-VL/Qwen2.5-VL-7B-Instruct", type=str)
...
parser.add_argument("--qwen_batch_size", default=32, type=int)
