"""
RULE Ablation: remove uncertainty / consensus / DRF, keep robust evidential loss
...
class cfg:
    """Configuration manager for RULE Ablation on DBP15K dataset."""
    ...
    def get_args(self):
        parser = argparse.ArgumentParser(description='RULE Ablation for DBP15K Dataset')
        ...
        # ==================== Loss Settings ====================
        parser.add_argument('--tau', type=float, default=0.07, help='Temperature for evidential loss')
