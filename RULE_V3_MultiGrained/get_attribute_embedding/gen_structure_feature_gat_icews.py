"""Generate pure GAT structure embeddings for ICEWS (V2)."""
import os
import sys
import argparse
...
def main(args):
    ...
    dataset_dir = os.path.join(ROOT_DIR, "data", args.data_split)
    output_dir = os.path.join(ROOT_DIR, "data", "pkls", args.data_split)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate pure GAT structure embeddings for ICEWS (V2)")
    parser.add_argument("--data_split", default="icews_wiki", choices=["icews_wiki", "icews_yago"])
